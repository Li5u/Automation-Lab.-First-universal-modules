...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        private bool CheckIfPlanesSortedByMaxLoadCapacity(List<Plane> planes)
        {
        ...
        public void CheckIfAirportHasTransportMilitaryPlanes()
        {
            ...
            bool hasMilitaryTransportPlane = transportMilitaryPlanes.Any();       

            Assert.IsTrue(hasMilitaryTransportPlane);
        }

        [Test]
        public void CompareActualAndExpextedPlanesWithMaxPassengerCapacity()
        {
            Airport airport = new Airport(planes);
            ...
            Assert.AreEqual(actualPlaneWithMaxPassengersCapacity.GetHashCode(), expectedPlaneWithMaxPassengersCapacity.GetHashCode());
        }
        ...
        public void test()
        {
            ...
            Assert.IsTrue(CheckIfPlanesSortedByMaxLoadCapacity(planesSortedByMaxLoadCapacity));
        }
    }
}
